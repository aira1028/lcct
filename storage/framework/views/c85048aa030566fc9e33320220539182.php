                ...
                <a href="<?php echo e(route('Admindashboard')); ?>">
                        ...
                        <div class="">
                         <img src="<?php echo e(asset('images/lcct.png')); ?>" alt="Violation Photo" class="w-16 h-16">
                          ...
                          <div class="text-center mt-2">
                             <label for="" class="font-black text-white text-xl " id="logo">LCCT Clinic</label>
                          </div>
                     </div>
                </a>
                 ...
                 <li>
                    <a href=""   class="flex items-center p-2 text-white hover:text-black rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                       ...
                       <span class="flex-1 ms-3 whitespace-nowrap">Record</span>
...
<?php /**PATH C:\Users\asus\Desktop\lcct\resources\views/components/patient-layout.blade.php ENDPATH**/ ?>
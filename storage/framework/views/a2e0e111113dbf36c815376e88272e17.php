...
<?php $component->withAttributes([]); ?>
    ...
    <h2 class="text-2xl font-semibold text-gray-700 mb-4">Exit Pass</h2>
    <div class="">
        <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('staff.exitpass', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-2665535287-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
<?php /**PATH C:\Users\asus\Desktop\lcct\resources\views/staff/exitpass.blade.php ENDPATH**/ ?>
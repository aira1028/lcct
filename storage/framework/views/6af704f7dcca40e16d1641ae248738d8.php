<div class="min-h-screen flex flex-col items-center py-10">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-full max-w-6xl">
        ...
        <div class="bg-white shadow-lg rounded-lg p-6 flex flex-col items-center">
            ...
            <p class="text-3xl font-bold text-cyan-500 mt-4"><?php echo e($todayPatients); ?></p>
        </div>

        <div class="bg-white shadow-lg rounded-lg p-6 flex flex-col items-center">
            <h2 class="text-xl font-semibold text-gray-700">This Week</h2>
            <p class="text-3xl font-bold text-cyan-500 mt-4"><?php echo e($weekPatients); ?></p>
        </div>

        <div class="bg-white shadow-lg rounded-lg p-6 flex flex-col items-center">
            <h2 class="text-xl font-semibold text-gray-700">This Month</h2>
            <p class="text-3xl font-bold text-cyan-500 mt-4"><?php echo e($monthPatients); ?></p>
        </div>

        <div class="bg-white shadow-lg rounded-lg p-6 flex flex-col items-center">
            <h2 class="text-xl font-semibold text-gray-700">This Year</h2>
            <p class="text-3xl font-bold text-cyan-500 mt-4"><?php echo e($yearPatients); ?></p>
        </div>

        <!-- Total Registered Users Card -->
        <div class="bg-white shadow-lg rounded-lg p-6 flex flex-col items-center">
            <h2 class="text-xl font-semibold text-gray-700">Total Users</h2>
            <p class="text-3xl font-bold text-cyan-500 mt-4"><?php echo e($totalUsers); ?></p>
        </div>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            const dailyPatients = <?php echo json_encode($dailyPatients, 15, 512) ?>;
...
<?php /**PATH C:\Users\asus\Desktop\lcct\resources\views/livewire/admin/index.blade.php ENDPATH**/ ?>
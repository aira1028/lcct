    ...
    <aside id="sidebar-multi-level-sidebar"
        ...
        <div class="h-full px-3 py-4 overflow-y-auto bg-cyan-500 ">
            <ul class="space-y-2 font-medium ">
                ...
                <li>
                    <a href="<?php echo e(route('staff.patient')); ?>"   class="flex items-center p-2 text-white hover:text-black rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                 ...
                 <li>
                    <a href="<?php echo e(route('staff.prescriptions')); ?>"   class="flex items-center p-2 text-white hover:text-black rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <i class="ri-user-star-fill"></i>
                ...
                <li>
                    <a href="<?php echo e(route('staff.treatments')); ?>"   class="flex items-center p-2 text-white hover:text-black rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                ...
                <li>
                    <a href="<?php echo e(route('staff.medicine')); ?>"   class="flex items-center p-2 text-white hover:text-black rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <i class="ri-capsule-fill"></i>
                 ...
                 <li>
                    <a href="<?php echo e(route('staff.medical')); ?>"   class="flex items-center p-2 text-white hover:text-black rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                 ...
                 <li>
                    <a href="<?php echo e(route('staff.dental')); ?>"   class="flex items-center p-2 text-white hover:text-black rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                 ...
                 <li>
                    <a href="<?php echo e(route('staff.certificate')); ?>"   class="flex items-center p-2 text-white hover:text-black rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                 ...
                 <li>
                    <a href="<?php echo e(route('staff.attendance')); ?>"   class="flex items-center p-2 text-white hover:text-black rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <i class="ri-nurse-fill"></i>
                 ...
                 <li>
                    <a href="<?php echo e(route('staff.exitpass')); ?>"   class="flex items-center p-2 text-white hover:text-black rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
...
<?php /**PATH C:\Users\asus\Desktop\lcct\resources\views/components/staff-layout.blade.php ENDPATH**/ ?>
<div class="flex items-center justify-center  ">
    <div class="text-center bg-white rounded-3xl shadow-2xl p-10 w-full ">
        ...
        <h1 class="text-5xl font-extrabold text-gray-800 mb-4">
            Hello, <span class="text-cyan-500"><?php echo e(Auth::user()->name ?? 'Guest'); ?></span>!
        </h1>
...
<?php /**PATH C:\Users\asus\Desktop\lcct\resources\views/livewire/patient/index.blade.php ENDPATH**/ ?>
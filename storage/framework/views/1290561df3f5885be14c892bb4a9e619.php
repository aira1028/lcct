        ...
        >
            ...
            >
                <div class="flex justify-between items-center p-4 border-b">
                    <h2 class="text-lg font-semibold"><?php echo e($medicineId ? 'Edit Medicine' : 'Add Medicine'); ?></h2>
                    <button
                ...
                <form wire:submit.prevent="save">
                    <div class="p-4 space-y-4">
                        <div>
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['medicineName'];
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div class="flex justify-end p-4 border-t">
                        <button type="submit" class="px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700">
                            <?php echo e($medicineId ? 'Update' : 'Save'); ?>
            ...
            <tbody>
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $medicines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $medicine): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="hover:bg-gray-50">
                        <td class="py-3 px-4 border-b"><?php echo e($medicine->name); ?></td>
                        <td class="py-3 px-4 border-b"><?php echo e($medicine->description); ?></td>
                        <td class="py-3 px-4 border-b"><?php echo e($medicine->quantity); ?></td> <!-- Display Quantity -->
                        <td class="py-3 px-4 border-b space-x-2">
                            <button wire:click="edit(<?php echo e($medicine->id); ?>)" class="px-3 py-1 bg-yellow-500 text-white rounded-md hover:bg-yellow-600 transition">
                                Edit
                            </button>
                            <button wire:click="delete(<?php echo e($medicine->id); ?>)" class="px-3 py-1 bg-red-500 text-white rounded-md hover:bg-red-600 transition">
                                Delete
                            </button>
                        </td>
                    </tr>
...
<?php /**PATH C:\Users\asus\Desktop\lcct\resources\views/livewire/staff/medicine.blade.php ENDPATH**/ ?>